    ...
    <div id="outer">
            ...
            <div class="verticalmenu">
                <ul>
                    ...
                    <c:if test="${admin_visible}">
                        ...
                        <li><a href="#" onclick="$('#detalle').load('mantenimiento/usuarios.jsp')">Cuenta Usuario</a>
                        </li>
                    </c:if>
                </ul>
            </div>
        ...
        <div id="content">
            ...
            <div id="detalle" style="padding: 15px;">
                <jsp:include page="mantenimiento/principal.jsp" flush="true"/>
            </div>
        </div><!-- end content -->
    </div><!-- end outer -->
    <div id="footer">
        <center>
            <h1>Demo realizada por <a href="https://www.linkedin.com/in/césar-díaz-lurita-7b503342/" target="_blank">Cesardl</a>
            </h1>
        </center>
    </div>
</div><!-- end container -->
